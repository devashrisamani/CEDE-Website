...
// Function to get recommendation based on user responses
function getRecommendation() {
  // Your existing code for handling the recommendation logic
  console.log("getRecommendation function called");
}
...
function selectOption(element) {
  ...
  if (submitButton) {
    ...
    console.error("submit-button not found in the DOM during selectOption");
  }
}
