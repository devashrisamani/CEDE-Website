...
function getRecommendation() {
  ...
  if (matchingRule) {
    // Trim the recommendation to avoid any extra spaces or line breaks
    const recommendationText = matchingRule.recommendation.trim();
    console.log("Storing recommendation in localStorage:", recommendationText);
