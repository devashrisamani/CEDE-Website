...
function getRecommendation() {
  const q1Value = document.querySelector('input[name="q1"]:checked')?.value.trim();
  const q2Value = document.querySelector('input[name="q2"]:checked')?.value.trim();
  const q3Value = document.querySelector('input[name="q3"]:checked')?.value.trim();
  const q3aValue = document.querySelector('input[name="q3a"]:checked')?.value.trim();
  ...
  // Log the keys in responseMapping to compare
  console.log("responseMapping keys:", Object.keys(responseMapping));
  ...
  if (matchingRule) {
    ...
    console.log("No recommendation found for the given responses:", userResponses);
